    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            By accessing and using NorthPath Strategies&apos; website and services, you accept 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            including vendor documentation packages, LMS connectors, evaluation operations 
            toolkits, and related consulting services.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            We grant you a personal, non-exclusive, non-transferable license to use our 
            services and materials for your internal business purposes only.
          </p>
        ...
        <section className="mb-8">
          ...
          <p>
            All content, documentation, and materials provided by NorthPath Strategies 
            remain our intellectual property. You receive a license to use, not ownership.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            To the maximum extent permitted by law, NorthPath Strategies shall not be 
