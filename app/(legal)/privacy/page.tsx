    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            NorthPath Strategies (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              Payment information when you purchase our services (processed securely through Stripe)
            </li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6">
            <li>
              <strong>Service Providers:</strong> Stripe (payments), hosting providers, analytics
              services
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            including encryption, access controls, and regular security assessments. However, no
