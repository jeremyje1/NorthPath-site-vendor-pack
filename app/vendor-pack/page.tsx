...
export default function VendorPack() {
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <p>HECVAT‑Lite answers, VPAT/ACR template, EU AI Act timeline + checklist, NIST AI RMF mapping, and a one‑page procurement cover sheet.</p>
      <ul className="list-disc pl-6 text-gray-700">
        <li>Editable templates</li><li>WCAG 2.2 notes</li><li>FERPA‑aware language</li>
      </ul>
