export const metadata = {
  ...
  description:
    "Pre-built integration patterns for Canvas, Banner, SharePoint and other Higher Education systems",
};
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto">
          Remove integration blockers early with pre-built connector patterns, API documentation,
          and deployment guides for major Higher Education platforms.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <div className="card p-6 border">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            REST API patterns, OAuth flows, grade passback, course provisioning, and data sync
            implementations.
          </p>
        ...
        <div className="card p-6 border">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            Student Information System integration patterns for enrollment, demographics, and
        ...
        <div className="card p-6 border">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            Document management, collaboration spaces, and workflow integration for campus-wide
            content systems.
          </p>
          <ul className="text-xs space-y-1">
        ...
        <div className="card p-6 border">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            Legacy LMS integration patterns, content migration strategies, and parallel deployment
            approaches.
          </p>
          <ul className="text-xs space-y-1">
        ...
        <div className="card p-6 border">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            Open-source LMS customization guides, plugin development patterns, and campus hosting
            considerations.
          </p>
          <ul className="text-xs space-y-1">
        ...
        <div className="card p-6 border">
          ...
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
            Campus identity management integration for seamless authentication and directory
            services.
          </p>
          <ul className="text-xs space-y-1">
      ...
      <div className="text-center">
        ...
        <p className="text-neutral-600 dark:text-neutral-300 mb-6">
          Get connector documentation and implementation guides that work with real campus IT
          constraints.
        </p>
